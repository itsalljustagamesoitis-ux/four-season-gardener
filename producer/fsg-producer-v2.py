#!/usr/bin/env python3
"""
FSG producer — thin shell over affiliate-platform producer.

All logic lives in affiliate-platform/producer/producer_main.py.
The original fsg-producer.py is preserved in .legacy/ for reference.

Usage:
  python3 producer/fsg-producer-v2.py --id 3
  python3 producer/fsg-producer-v2.py --count 10
  python3 producer/fsg-producer-v2.py --count 5 --type Roundup
  python3 producer/fsg-producer-v2.py --slug my-article-slug
  python3 producer/fsg-producer-v2.py --dry-run --count 5
"""
